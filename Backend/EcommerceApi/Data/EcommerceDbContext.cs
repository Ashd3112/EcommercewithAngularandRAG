...
namespace EcommerceApi.Data
{
    public class EcommerceDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // We seed initial products to give our RAG database content to search.
            // Let's create a dynamic list of premium products. We don't pre-calculate VectorJson
            // in this seed directly, or we can seed them with empty vectors and let our search service
            // populate or compute vectors dynamically at startup / search time!
            // Actually, calculating vectors at startup is very clean. Let's just seed standard products.
