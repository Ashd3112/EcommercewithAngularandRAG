...
// Add Custom Services for Semantic Search
builder.Services.AddSingleton<ISemanticSearchService, SemanticSearchService>();

builder.Services.AddControllers();

// Configure CORS to allow access from Angular and Gateway/other services
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        Console.WriteLine("ProductService database initialized and vectors computed successfully.");
    }
    catch (Exception ex)
    {
